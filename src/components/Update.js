...
<br></br>
             ...
             <button type="button" className="btn btn-primary" onClick={(event)=>saveForm(event)}>Submit</button> 
        </form>
</div>
</div></div>
</div>
</div>
<div class="p-1"> < img class="img-fluid rounded-circle" src={require('./assets/img/02.jpg') } width={250} height={250} /></div>
</div>
</section>
